        ...
        <meta charset="UTF-8">
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
                <meta name="viewport" content="width=device-width, initial-scale=1">
                    ...
                    <body>
                        <!--*|IF:MC_PREVIEW_TEXT|*-->
                        <!--[if !gte mso 9]><!----><span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;"><?= $subject ?></span><!--<![endif]-->
                        <!--*|END:IF|*-->
                        <center>
                                                                                ...
                                                                                <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                                                                    <tbody><tr>
                                                                                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                                                                                ...
                                                                                                <img align="center" alt="" src="<?= Yii::$app->getModule("authy")->logo?>" width="360" style="max-width:360px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                                                                                                                        ...
                                                                                                                        <tbody><tr>
                                                                                                                                <td valign="top" class="mcnCaptionRightContentInner" style="padding:0 9px ;">
                                                                                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnCaptionRightImageContentContainer" width="132">
                                                                                                                                        <tbody><tr>
                                                                                                                                                <td class="mcnCaptionRightImageContent" align="center" valign="top">
                                                                                                                                                    ...
                                                                                                                                                    <img alt="" src="<?= Yii::$app->getModule("authy")->logo?>" width="132" style="max-width:640px;" class="mcnImage">
                                                                                                                                    ...
                                                                                                                                    <table class="mcnCaptionRightTextContentContainer" align="right" border="0" cellpadding="0" cellspacing="0" width="396">
                                                                                                                                        <tbody><tr>
                                                                                                                                                <td valign="top" class="mcnTextContent" style="font-size: 16px; line-height: 150%;">
                                                                                                                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                                                        <tbody>
                                                                                                                                                            <tr>
                                                                                                                                                                <td align="right" width="120"><?= Yii::t('authy', 'Device') ?>: </td>
                                                                                                                                                                <td><?= $model->getBrowserConcat()?></td>
                                                                                                                                                            </tr>
                                                                                                                                                            <tr>
                                                                                                                                                                <td align="right" width="120"><?= Yii::t('authy', 'Time') ?>：</td>
                                                                                                                                                                <td><?= date('Y/m/d H:i:s')?></td>
                                                                                                                                                            </tr>
                                                                                                                                                            <tr>
                                                                                                                                                                <td align="right" width="120"><?= Yii::t('authy', 'IP Address') ?>：</td>
                                                                                                                                                                <td><?= $model->ip?></td>
                                                                                                                                                            </tr>
                                                                                                                                                        </tbody>
                                                                                                                                                    </table>
                                                                                                                    ...
                                                                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                                                                                        <tbody><tr>
                                                                                                                                ...
                                                                                                                                <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                                                                                    ...
                                                                                                                                    <p><?= Yii::t('authy', 'If this activity is not your own operation, please contact your administrator.') ?></p>
