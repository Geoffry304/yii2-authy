...
class Detect {
    ...
    public static function init() {
        ...
        self::$detect->setDetectionType(MobileDetect::DETECTION_TYPE_EXTENDED);
        self::getIp();
    }

    private static function getIp() {
        #self::$setDetectionType(MobileDetect::DETECTION_TYPE_EXTENDED);
        ...
        if (in_array(self::$ipAddress, array('::1', '127.0.0.1', 'localhost')) || self::ip_is_private(self::$ipAddress)) {
    ...
    public static function os() {
        ...
        if (self::$detect->isAndroidOS()) {
            if (self::$detect->version('Android') !== false) {
                ...
                switch (true) {
                    case self::$detect->version('Android') >= 8.0: $codeName = ' (Oreo)';
                        break;
                    case self::$detect->version('Android') >= 7.0: $codeName = ' (Nougat)';
                        break;
                    case self::$detect->version('Android') >= 6.0: $codeName = ' (Marshmallow)';
                        break;
                    case self::$detect->version('Android') >= 5.0: $codeName = ' (Lollipop)';
                        break;
                    case self::$detect->version('Android') >= 4.4: $codeName = ' (KitKat)';
                        break;
                    case self::$detect->version('Android') >= 4.1: $codeName = ' (Jelly Bean)';
                        break;
                    case self::$detect->version('Android') >= 4.0: $codeName = ' (Ice Cream Sandwich)';
                        break;
                    case self::$detect->version('Android') >= 3.0: $codeName = ' (Honeycomb)';
                        break;
                    case self::$detect->version('Android') >= 2.3: $codeName = ' (Gingerbread)';
                        break;
                    case self::$detect->version('Android') >= 2.2: $codeName = ' (Froyo)';
                        break;
                    case self::$detect->version('Android') >= 2.0: $codeName = ' (Eclair)';
                        break;
                    case self::$detect->version('Android') >= 1.6: $codeName = ' (Donut)';
                        break;
                    case self::$detect->version('Android') >= 1.5: $codeName = ' (Cupcake)';
                        break;
                    default: $codeName = '';
                        break;
                }
            ...
            switch (self::$detect->version('Windows NT')) {
                ...
                case 4.0: $codeName = ' NT 4.0';
                    break;
                default: $codeName = ' NT v' . self::$detect->version('Windows NT');
                    break;
            }
            $os = 'Windows' . $codeName;
    ...
    public static function ip() {
        if (self::$ipAddress == 'localhost' && is_null(self::$ipInfo) && !self::$ipInfoError) {
            self::getIpInfo();
        }
    ...
    public static function ipInfoSrc() {
        if (is_null(self::$ipInfo) && !self::$ipInfoError) {
            self::getIpInfo();
        }
